...
function selec(yrs){
	$( function() {
		grp_league22 = $.map(grp_league_u20, function(element, index) {
			if (element[0] == "년도" || element[0] == yrs) {
				return [element]
			};
		});

		w_cup22 = $.map(w_cuptm_u20, function(element, index) {
...
function drawt(){
	$( function() {
		ttxt = '<div id="t33">' + yrs + ' u20 월드컵축구 대진표 (제' + rnd + '회)</br><span class="t35">- 우 승 : </span><span id="t35" class="t36"></span></br><span class="t35">-준우승:</span><span id="t36" class="t36"></span></br><span class="t35">- 3 위 : </span><span id="t37" class="t36"></span></br><span class="t35">- 4 위 : </span><span id="t38" class="t36"></span></div>';
		if (sele==1){
